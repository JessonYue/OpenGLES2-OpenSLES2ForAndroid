...
package douyin.jesson.com.fangdouyin.record.video;
...
import douyin.jesson.com.fangdouyin.gpufilter.basefilter.MagicCameraInputFilter;
import douyin.jesson.com.fangdouyin.record.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(AppApplication.getContext().getResources());
