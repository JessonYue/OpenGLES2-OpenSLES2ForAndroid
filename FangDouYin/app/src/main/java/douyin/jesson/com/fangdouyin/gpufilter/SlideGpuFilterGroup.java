package douyin.jesson.com.fangdouyin.gpufilter;
...
import douyin.jesson.com.fangdouyin.gpufilter.helper.MagicFilterFactory;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(AppApplication.getContext());
    }
